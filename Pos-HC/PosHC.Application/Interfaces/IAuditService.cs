...
public interface IAuditService
{
    ...
    Task<PagedResult<AuditEntryDetailsDto>> GetPageAsync(string search, int page, CancellationToken cancellationToken, int pageSize = 50, string? sortBy = null, string? sortDirection = null);
}
