...
{
    public Task<PagedResult<StaffUser>> GetPageAsync(int page, CancellationToken cancellationToken)
    {
        return PagedQuery.ReadAsync<StaffUser>(store, null, page, cancellationToken);
    }
