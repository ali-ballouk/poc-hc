...
public class AppointmentController(IAppointmentService appointments) : ControllerBase
{
    ...
    public Task<PagedResult<Appointment>> GetPage(DateTime? from = null, DateTime? to = null, int page = 1, CancellationToken ct = default)
        => appointments.GetPageAsync(from, to, page, ct);
